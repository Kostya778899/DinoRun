...
[CreateAssetMenu(menuName = "Containers/ComponentsContainer", fileName = "NewComponentsContainer")]
public class ComponentsContainer : ScriptableObject
{
    ...
    public void Set(List<Component> values) => Values = CArray.Copy<Component>(values);
    ...
    public virtual void OnValidateVaules()
    {
        if (Values != null && Values[0] != null)
        {
            ...
            if (!containerSet)
            {
                ...
                CEditor.SetObjectDirty(containerSet.gameObject);
            }

            if (containerSet.Container == this) containerSet.Values = CArray.Copy<Component>(Values);
        }
    }
